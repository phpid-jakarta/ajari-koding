...
const paths = {
  ...
  help_us: [
    `M9.669.864L8 0 6.331.864l-1.858.282-.842 1.68-1.337 1.32L2.6
  ...
  new_issue: [
    `M2 3a2 2 0 0 1 2-2h5.293a1 1 0 0 1 .707.293L13.707 5a1 1 0 0 1
  ...
  tab_semua: [
    `M4 1h8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V3a2 2 0 0 1
      2-2zm0 1a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V3a1 1 0 0
      0-1-1H4z`,
    'M13 6H3V5h10v1zm0 3H3V8h10v1zm0 3H3v-1h10v1z',
    'M5 14V6h1v8H5z'
  ],
  tab_video: [
    `M2.667 3.5c-.645 0-1.167.522-1.167 1.167v6.666c0 .645.522 1.167 1.167
    ...
    `M11.25 5.65l2.768-1.605a.318.318 0 0 1 .482.263v7.384c0
  ...
  tab_portal: [
    `M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5 8 5.961 14.154 3.5 8.186
